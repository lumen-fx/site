...
# Lumen FX documentation

Documentation for Lumen and its scripting language, Candela. Search covers both.
...
The Rust desktop UI framework: `.lmn` markup, real CSS, compiled by `lumenc`.
The Lumen docs are being migrated to this site.

[Lumen docs](lumen/){ .md-button }
</div>
